...
namespace ConfiApp
{
    ...
    public partial class TicketsPFechaGestor : ContentPage
    {
        ...
        public async void GetMoraApis()
        {
           ...
           //UserDialogs.Instance.ShowLoading("Consultando");
            ...
            request.RequestUri = new Uri(App.Current.Properties["DDNS"].ToString() + "/ApiTicketsPfechaGestor?Usuario=" + App.Current.Properties["name"].ToString() + "&FechaInicio="+ DateInicio.Date.ToString("yyyy-MM-dd") + "&FechaFin=" + DateFin.Date.ToString("yyyy-MM-dd"));
...
public void OnSearchBarTextChanged(object obj)
        ...
        private async void Button_ClickedAsync(object sender, EventArgs e)
        {
            ...
            await App.MasterDet.Detail.Navigation.PushAsync(new Ticket(Convert.ToInt32(Btn.ClassId)));

        }
    }


    public class TicketsFecha
    {
        public int id { get; set; }
        public string Nombre { get; set; }
